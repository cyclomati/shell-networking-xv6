...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	36e58593          	addi	a1,a1,878 # 1380 <malloc+0x100>
      1a:	8532                	mv	a0,a2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	33058593          	addi	a1,a1,816 # 1390 <malloc+0x110>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	12c080e7          	jalr	300(ra) # 1196 <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2fe50513          	addi	a0,a0,766 # 1398 <malloc+0x118>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	3d270713          	addi	a4,a4,978 # 1498 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      e6:	2be50513          	addi	a0,a0,702 # 13a0 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	2a458593          	addi	a1,a1,676 # 13a8 <malloc+0x128>
     10c:	4509                	li	a0,2
     10e:	00001097          	auipc	ra,0x1
     112:	088080e7          	jalr	136(ra) # 1196 <fprintf>
  exit(0);
     116:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     154:	26858593          	addi	a1,a1,616 # 13b8 <malloc+0x138>
     158:	4509                	li	a0,2
     15a:	00001097          	auipc	ra,0x1
     15e:	03c080e7          	jalr	60(ra) # 1196 <fprintf>
      exit(1);
     162:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1ea:	1e250513          	addi	a0,a0,482 # 13c8 <malloc+0x148>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28c:	ff8080e7          	jalr	-8(ra) # 1280 <malloc>
     290:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d6:	fae080e7          	jalr	-82(ra) # 1280 <malloc>
     2da:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     330:	f54080e7          	jalr	-172(ra) # 1280 <malloc>
     334:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     336:	4661                	li	a2,24
     338:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     376:	f0e080e7          	jalr	-242(ra) # 1280 <malloc>
     37a:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37c:	4661                	li	a2,24
     37e:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b8:	ecc080e7          	jalr	-308(ra) # 1280 <malloc>
     3bc:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3be:	4641                	li	a2,16
     3c0:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	e3cb0b13          	addi	s6,s6,-452 # 13f0 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ce:	e0650513          	addi	a0,a0,-506 # 13d0 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	d5260613          	addi	a2,a2,-686 # 13f8 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6ea:	d32b0b13          	addi	s6,s6,-718 # 1418 <malloc+0x198>
  ...
  return ret;
     ...
     720:	ce450513          	addi	a0,a0,-796 # 1400 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     77e:	c8e50513          	addi	a0,a0,-882 # 1408 <malloc+0x188>
...
00000000000007aa <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ce:	c5660613          	addi	a2,a2,-938 # 1420 <malloc+0x1a0>
     7d2:	85a6                	mv	a1,s1
     7d4:	854a                	mv	a0,s2
...
000000000000081e <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     840:	beca0a13          	addi	s4,s4,-1044 # 1428 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     876:	bbe60613          	addi	a2,a2,-1090 # 1430 <malloc+0x1b0>
     87a:	85ce                	mv	a1,s3
     87c:	854a                	mv	a0,s2
...
00000000000008c6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8dc:	b2060613          	addi	a2,a2,-1248 # 13f8 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     90c:	b4060613          	addi	a2,a2,-1216 # 1448 <malloc+0x1c8>
     910:	85ca                	mv	a1,s2
     912:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     94e:	aee50513          	addi	a0,a0,-1298 # 1438 <malloc+0x1b8>
     952:	fffff097          	auipc	ra,0xfffff
     956:	704080e7          	jalr	1796(ra) # 56 <panic>
    panic("syntax - missing )");
     95a:	00001517          	auipc	a0,0x1
     95e:	af650513          	addi	a0,a0,-1290 # 1450 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     98a:	b2a70713          	addi	a4,a4,-1238 # 14b0 <malloc+0x230>
...
0000000000000a02 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a3a:	95260613          	addi	a2,a2,-1710 # 1388 <malloc+0x108>
     a3e:	85a6                	mv	a1,s1
     a40:	854a                	mv	a0,s2
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a70:	9fc58593          	addi	a1,a1,-1540 # 1468 <malloc+0x1e8>
     a74:	4509                	li	a0,2
     a76:	00000097          	auipc	ra,0x0
     a7a:	720080e7          	jalr	1824(ra) # 1196 <fprintf>
    panic("syntax");
     a7e:	00001517          	auipc	a0,0x1
     a82:	98250513          	addi	a0,a0,-1662 # 1400 <malloc+0x180>
...
0000000000000a8e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     aa4:	9d890913          	addi	s2,s2,-1576 # 1478 <malloc+0x1f8>
     aa8:	85a6                	mv	a1,s1
     aaa:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b5c:	92858593          	addi	a1,a1,-1752 # 1480 <malloc+0x200>
     b60:	4509                	li	a0,2
     b62:	00000097          	auipc	ra,0x0
     b66:	634080e7          	jalr	1588(ra) # 1196 <fprintf>
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     f26:	f04a                	sd	s2,32(sp)
     f28:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     f2e:	cad9                	beqz	a3,fc4 <printint+0xa4>
     f30:	01f5d79b          	srliw	a5,a1,0x1f
     f34:	cbc1                	beqz	a5,fc4 <printint+0xa4>
    neg = 1;
    x = -xx;
  ...
  do{
    buf[i++] = digits[x % base];
     f44:	00000817          	auipc	a6,0x0
     f48:	5dc80813          	addi	a6,a6,1500 # 1520 <digits>
     f4c:	88ba                	mv	a7,a4
     f4e:	0017051b          	addiw	a0,a4,1
     f52:	872a                	mv	a4,a0
     f54:	02c5f7bb          	remuw	a5,a1,a2
     f58:	1782                	slli	a5,a5,0x20
     f5a:	9381                	srli	a5,a5,0x20
     f5c:	97c2                	add	a5,a5,a6
     ...
     f6e:	fcc7ffe3          	bgeu	a5,a2,f4c <printint+0x2c>
  if(neg)
     f72:	00030c63          	beqz	t1,f8a <printint+0x6a>
    buf[i++] = '-';
     f76:	fd050793          	addi	a5,a0,-48
     f7a:	00878533          	add	a0,a5,s0
     f7e:	02d00793          	li	a5,45
     f82:	fef50823          	sb	a5,-16(a0)
     f86:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
     f8a:	02e05763          	blez	a4,fb8 <printint+0x98>
     f8e:	f426                	sd	s1,40(sp)
     f90:	377d                	addiw	a4,a4,-1
     f92:	00e984b3          	add	s1,s3,a4
     f96:	19fd                	addi	s3,s3,-1
  ...
  while(--i >= 0)
     fb0:	14fd                	addi	s1,s1,-1
     fb2:	ff3498e3          	bne	s1,s3,fa2 <printint+0x82>
     fb6:	74a2                	ld	s1,40(sp)
}
     fb8:	70e2                	ld	ra,56(sp)
     fba:	7442                	ld	s0,48(sp)
  ...
  neg = 0;
     fc4:	4301                	li	t1,0
     fc6:	bf9d                	j	f3c <printint+0x1c>

0000000000000fc8 <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     fca:	e486                	sd	ra,72(sp)
     fcc:	e0a2                	sd	s0,64(sp)
     fce:	f84a                	sd	s2,48(sp)
     fd0:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fd6:	1a090b63          	beqz	s2,118c <vprintf+0x1c4>
     fda:	fc26                	sd	s1,56(sp)
     fdc:	f44e                	sd	s3,40(sp)
     fde:	f052                	sd	s4,32(sp)
     fe0:	ec56                	sd	s5,24(sp)
     fe2:	e85a                	sd	s6,16(sp)
     fe4:	e45e                	sd	s7,8(sp)
     fe6:	8aaa                	mv	s5,a0
     fe8:	8bb2                	mv	s7,a2
     fea:	00158493          	addi	s1,a1,1
  state = 0;
     fee:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
     ...
     ff0:	02500a13          	li	s4,37
     ff4:	4b55                	li	s6,21
     ff6:	a839                	j	1014 <vprintf+0x4c>
        putc(fd, c);
     ff8:	85ca                	mv	a1,s2
     ffa:	8556                	mv	a0,s5
     ffc:	00000097          	auipc	ra,0x0
    1000:	f02080e7          	jalr	-254(ra) # efe <putc>
    1004:	a019                	j	100a <vprintf+0x42>
    } else if(state == '%'){
    1006:	01498d63          	beq	s3,s4,1020 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    100a:	0485                	addi	s1,s1,1
    100c:	fff4c903          	lbu	s2,-1(s1)
    1010:	16090863          	beqz	s2,1180 <vprintf+0x1b8>
    if(state == 0){
    1014:	fe0999e3          	bnez	s3,1006 <vprintf+0x3e>
      if(c == '%'){
    1018:	ff4910e3          	bne	s2,s4,ff8 <vprintf+0x30>
        state = '%';
    101c:	89d2                	mv	s3,s4
    101e:	b7f5                	j	100a <vprintf+0x42>
      if(c == 'd'){
    1020:	13490563          	beq	s2,s4,114a <vprintf+0x182>
    1024:	f9d9079b          	addiw	a5,s2,-99
    1028:	0ff7f793          	zext.b	a5,a5
    102c:	12fb6863          	bltu	s6,a5,115c <vprintf+0x194>
    1030:	f9d9079b          	addiw	a5,s2,-99
    1034:	0ff7f713          	zext.b	a4,a5
    1038:	12eb6263          	bltu	s6,a4,115c <vprintf+0x194>
    103c:	00271793          	slli	a5,a4,0x2
    1040:	00000717          	auipc	a4,0x0
    1044:	48870713          	addi	a4,a4,1160 # 14c8 <malloc+0x248>
    ...
    1062:	ec2080e7          	jalr	-318(ra) # f20 <printint>
    1066:	8bca                	mv	s7,s2
      } else {
    ...
    107e:	ea6080e7          	jalr	-346(ra) # f20 <printint>
    1082:	8bca                	mv	s7,s2
      state = 0;
    1084:	4981                	li	s3,0
    1086:	b751                	j	100a <vprintf+0x42>
    ...
    109a:	e8a080e7          	jalr	-374(ra) # f20 <printint>
    109e:	8bca                	mv	s7,s2
      state = 0;
    10a0:	4981                	li	s3,0
    10a2:	b7a5                	j	100a <vprintf+0x42>
    10a4:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    10a6:	008b8793          	addi	a5,s7,8
    10aa:	8c3e                	mv	s8,a5
    10ac:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    10b0:	03000593          	li	a1,48
    10b4:	8556                	mv	a0,s5
    10b6:	00000097          	auipc	ra,0x0
    10ba:	e48080e7          	jalr	-440(ra) # efe <putc>
  putc(fd, 'x');
    10be:	07800593          	li	a1,120
    10c2:	8556                	mv	a0,s5
    10c4:	00000097          	auipc	ra,0x0
    10c8:	e3a080e7          	jalr	-454(ra) # efe <putc>
    10cc:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10ce:	00000b97          	auipc	s7,0x0
    10d2:	452b8b93          	addi	s7,s7,1106 # 1520 <digits>
    10d6:	03c9d793          	srli	a5,s3,0x3c
    10da:	97de                	add	a5,a5,s7
    10dc:	0007c583          	lbu	a1,0(a5)
    10e0:	8556                	mv	a0,s5
    10e2:	00000097          	auipc	ra,0x0
    10e6:	e1c080e7          	jalr	-484(ra) # efe <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10ea:	0992                	slli	s3,s3,0x4
    10ec:	397d                	addiw	s2,s2,-1
    10ee:	fe0914e3          	bnez	s2,10d6 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
    10f2:	8be2                	mv	s7,s8
      state = 0;
    10f4:	4981                	li	s3,0
    10f6:	6c02                	ld	s8,0(sp)
    10f8:	bf09                	j	100a <vprintf+0x42>
        s = va_arg(ap, char*);
    10fa:	008b8993          	addi	s3,s7,8
    10fe:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    1102:	02090163          	beqz	s2,1124 <vprintf+0x15c>
        while(*s != 0){
    1106:	00094583          	lbu	a1,0(s2)
    110a:	c9a5                	beqz	a1,117a <vprintf+0x1b2>
          putc(fd, *s);
    110c:	8556                	mv	a0,s5
    ...
    111c:	f9e5                	bnez	a1,110c <vprintf+0x144>
        s = va_arg(ap, char*);
    111e:	8bce                	mv	s7,s3
      state = 0;
    1120:	4981                	li	s3,0
    1122:	b5e5                	j	100a <vprintf+0x42>
          s = "(null)";
    1124:	00000917          	auipc	s2,0x0
    1128:	36c90913          	addi	s2,s2,876 # 1490 <malloc+0x210>
        while(*s != 0){
    112c:	02800593          	li	a1,40
    1130:	bff1                	j	110c <vprintf+0x144>
    ...
    1172:	d90080e7          	jalr	-624(ra) # efe <putc>
      state = 0;
    1176:	4981                	li	s3,0
    1178:	bd49                	j	100a <vprintf+0x42>
        s = va_arg(ap, char*);
    117a:	8bce                	mv	s7,s3
      state = 0;
    117c:	4981                	li	s3,0
    117e:	b571                	j	100a <vprintf+0x42>
    1180:	74e2                	ld	s1,56(sp)
    1182:	79a2                	ld	s3,40(sp)
    1184:	7a02                	ld	s4,32(sp)
    1186:	6ae2                	ld	s5,24(sp)
    1188:	6b42                	ld	s6,16(sp)
    118a:	6ba2                	ld	s7,8(sp)
    }
  }
}
    118c:	60a6                	ld	ra,72(sp)
    118e:	6406                	ld	s0,64(sp)
    1190:	7942                	ld	s2,48(sp)
    1192:	6161                	addi	sp,sp,80
    1194:	8082                	ret

0000000000001196 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    1196:	715d                	addi	sp,sp,-80
    1198:	ec06                	sd	ra,24(sp)
    119a:	e822                	sd	s0,16(sp)
    119c:	1000                	addi	s0,sp,32
    119e:	e010                	sd	a2,0(s0)
    11a0:	e414                	sd	a3,8(s0)
    11a2:	e818                	sd	a4,16(s0)
    11a4:	ec1c                	sd	a5,24(s0)
    11a6:	03043023          	sd	a6,32(s0)
    11aa:	03143423          	sd	a7,40(s0)
  va_list ap;
  ...
  vprintf(fd, fmt, ap);
    ...
    11b8:	e14080e7          	jalr	-492(ra) # fc8 <vprintf>
}
...
{
    11c4:	711d                	addi	sp,sp,-96
    11c6:	ec06                	sd	ra,24(sp)
    11c8:	e822                	sd	s0,16(sp)
    11ca:	1000                	addi	s0,sp,32
    11cc:	e40c                	sd	a1,8(s0)
    11ce:	e810                	sd	a2,16(s0)
    11d0:	ec14                	sd	a3,24(s0)
    11d2:	f018                	sd	a4,32(s0)
    11d4:	f41c                	sd	a5,40(s0)
    11d6:	03043823          	sd	a6,48(s0)
    11da:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    11de:	00840613          	addi	a2,s0,8
    11e2:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    11e6:	85aa                	mv	a1,a0
    11e8:	4505                	li	a0,1
    11ea:	00000097          	auipc	ra,0x0
    11ee:	dde080e7          	jalr	-546(ra) # fc8 <vprintf>
}
    11f2:	60e2                	ld	ra,24(sp)
    11f4:	6442                	ld	s0,16(sp)
    11f6:	6125                	addi	sp,sp,96
    11f8:	8082                	ret

00000000000011fa <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    11fc:	e406                	sd	ra,8(sp)
    11fe:	e022                	sd	s0,0(sp)
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    120e:	a039                	j	121c <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1210:	6398                	ld	a4,0(a5)
    1212:	00e7e463          	bltu	a5,a4,121a <free+0x20>
    1216:	00e6ea63          	bltu	a3,a4,122a <free+0x30>
{
    121a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    121c:	fed7fae3          	bgeu	a5,a3,1210 <free+0x16>
    1220:	6398                	ld	a4,0(a5)
    1222:	00e6e463          	bltu	a3,a4,122a <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1226:	fee7eae3          	bltu	a5,a4,121a <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    ...
    123a:	02e60563          	beq	a2,a4,1264 <free+0x6a>
  ...
  if(p + p->s.size == bp){
    ...
    124e:	02e68263          	beq	a3,a4,1272 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  ...
  freep = p;
    ...
    125e:	6402                	ld	s0,0(sp)
    1260:	0141                	addi	sp,sp,16
    1262:	8082                	ret
    bp->s.size += p->s.ptr->s.size;
    1264:	4618                	lw	a4,8(a2)
    1266:	9f2d                	addw	a4,a4,a1
    1268:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    126c:	6398                	ld	a4,0(a5)
    126e:	6310                	ld	a2,0(a4)
    1270:	b7f9                	j	123e <free+0x44>
    p->s.size += bp->s.size;
    1272:	ff852703          	lw	a4,-8(a0)
    1276:	9f31                	addw	a4,a4,a2
    1278:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    127a:	ff053683          	ld	a3,-16(a0)
    127e:	bfd1                	j	1252 <free+0x58>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    128c:	02051993          	slli	s3,a0,0x20
    1290:	0209d993          	srli	s3,s3,0x20
    1294:	09bd                	addi	s3,s3,15
    1296:	0049d993          	srli	s3,s3,0x4
    129a:	2985                	addiw	s3,s3,1
    129c:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    129e:	00001517          	auipc	a0,0x1
    12a2:	d7253503          	ld	a0,-654(a0) # 2010 <freep>
    12a6:	c905                	beqz	a0,12d6 <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12a8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12aa:	4798                	lw	a4,8(a5)
    12ac:	09377a63          	bgeu	a4,s3,1340 <malloc+0xc0>
    12b0:	f426                	sd	s1,40(sp)
    12b2:	e852                	sd	s4,16(sp)
    12b4:	e456                	sd	s5,8(sp)
    12b6:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    12b8:	8a4e                	mv	s4,s3
    12ba:	6705                	lui	a4,0x1
    12bc:	00e9f363          	bgeu	s3,a4,12c2 <malloc+0x42>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    12ca:	00001497          	auipc	s1,0x1
    12ce:	d4648493          	addi	s1,s1,-698 # 2010 <freep>
  if(p == (char*)-1)
    12d2:	5afd                	li	s5,-1
    12d4:	a089                	j	1316 <malloc+0x96>
    12d6:	f426                	sd	s1,40(sp)
    ...
    if(p->s.size >= nunits){
    12f4:	b7d1                	j	12b8 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    12f6:	6398                	ld	a4,0(a5)
    12f8:	e118                	sd	a4,0(a0)
    12fa:	a8b9                	j	1358 <malloc+0xd8>
  hp->s.size = nu;
    12fc:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1300:	0541                	addi	a0,a0,16
    1302:	00000097          	auipc	ra,0x0
    1306:	ef8080e7          	jalr	-264(ra) # 11fa <free>
  return freep;
    130a:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    130c:	c135                	beqz	a0,1370 <malloc+0xf0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    130e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1310:	4798                	lw	a4,8(a5)
    1312:	03277363          	bgeu	a4,s2,1338 <malloc+0xb8>
    if(p == freep)
    1316:	6098                	ld	a4,0(s1)
    1318:	853e                	mv	a0,a5
    131a:	fef71ae3          	bne	a4,a5,130e <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    131e:	8552                	mv	a0,s4
    1320:	00000097          	auipc	ra,0x0
    1324:	b9e080e7          	jalr	-1122(ra) # ebe <sbrk>
  if(p == (char*)-1)
    1328:	fd551ae3          	bne	a0,s5,12fc <malloc+0x7c>
        return 0;
    132c:	4501                	li	a0,0
    ...
    1336:	a03d                	j	1364 <malloc+0xe4>
    1338:	74a2                	ld	s1,40(sp)
    133a:	6a42                	ld	s4,16(sp)
    133c:	6aa2                	ld	s5,8(sp)
    133e:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1340:	fae90be3          	beq	s2,a4,12f6 <malloc+0x76>
        p->s.size -= nunits;
    1344:	4137073b          	subw	a4,a4,s3
    1348:	c798                	sw	a4,8(a5)
        p += p->s.size;
    134a:	02071693          	slli	a3,a4,0x20
    134e:	01c6d713          	srli	a4,a3,0x1c
